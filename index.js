...
async function run() {
    try {
        ...
        // update operation, specific id based coffee
...
app.get('/', (req, res) => {
    res.send('Coffee master server is running')
})

app.listen(port, () => {
    console.log(`Master server is running at port ${port}`);
})